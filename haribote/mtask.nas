...
_init_pid:
	...
	XOR	EAX,EAX
	MOV	DWORD [-8+EBP],0
	MOV	DWORD [-80016+EBP],0
L7:
	MOV	DWORD [-80000+EBP+EAX*8],EAX
	INC	EAX
	CMP	EAX,9999
	JLE	L7
	XOR	EAX,EAX
L12:
	MOV	DWORD [-88016+EBP+EAX*8],EAX
	INC	EAX
	CMP	EAX,1000
	JLE	L12
	LEA	EAX,DWORD [-80000+EBP]
	MOV	DWORD [3850],EAX
	LEA	EAX,DWORD [-88016+EBP]
	MOV	DWORD [3855],EAX
	LEAVE
	RET
	GLOBAL	_pid_alloc
_pid_alloc:
	...
	MOV	ECX,DWORD [3850]
	MOV	EBP,ESP
	MOV	EAX,DWORD [79992+ECX]
	MOV	EDX,DWORD [8+EBP]
	MOV	DWORD [4+ECX+EAX*8],EDX
	LEA	EDX,DWORD [1+EAX]
	MOV	DWORD [79992+ECX],EDX
	POP	EBP
	ADD ESP,-1
	RET
	GLOBAL	_task_now
